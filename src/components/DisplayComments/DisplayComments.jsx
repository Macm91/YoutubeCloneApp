...
const DisplayComments=(props)=>{
    ...
    return(
            ...
            <div className="allComments" position-relative start-50 top-50>
                ...
                <h4>{val.comment} </h4>
                    <tr className="likes">
                    <th><form type="button" onClick={()=> increment(val)}> 
                    ...
                    <th><form type="button" onClick={()=> incrementDislikes(val)} > <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hand-thumbs-down" viewBox="0 0 16 16">
